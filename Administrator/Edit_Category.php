...
$sql1 = mysqli_query($dbConn,"update categories set Category_Name='$Name' where ID='$C_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Edit Book Category Information</h5>
                     ...
                     <form method="post" action="Edit_Category.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							...
							<input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Name *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="text" name="Name" value="<?php echo $Name; ?>" class="form-control" required></div>
                                </div>
