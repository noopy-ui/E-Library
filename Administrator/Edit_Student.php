...
$sql1 = mysqli_query($dbConn,"update students set Balance_Of_Volations='$Balance_Of_Volations', Status='$Status' where ID='$S_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Student.php?S_ID=<?php echo $S_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							...
							<input type="hidden" name="S_ID" value="<?php echo $S_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Balance Of Volations *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="nuumber" min="0" name="Balance_Of_Volations" value="<?php echo $Balance_Of_Volations; ?>" class="form-control" required></div>
                                </div>
