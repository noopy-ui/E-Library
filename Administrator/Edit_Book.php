...
$sql1 = mysqli_query($dbConn,"select * from books where ID='$B_ID'");
...
$sql1 = mysqli_query($dbConn,"update books set Status='$Status' where ID='$B_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Book.php?B_ID=<?php echo $B_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
