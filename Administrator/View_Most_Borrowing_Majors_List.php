            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Most Borrowing Majors List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from students group by Major");
					...
					$sql4 = mysqli_query($dbConn,"select * from borrowing_records where Student_Major='$Major'");
					if (mysqli_num_rows($sql4)>5){
