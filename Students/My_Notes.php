...
<body class="canvas-menu" style="style background-image: url('../img/bg.png'); background-size: 100% 100%; background-repeat: no-repeat;">
  ...
  border-bottom-right-radius: 35px;
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>My Borrowing Books | <a href="Add_New_Note.php?B_ID=<?php echo $B_ID; ?>" class="btn btn-primary">Add New Note</a></h2>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>My Book Notes List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from notes where S_ID='$S_ID' AND B_ID='$B_ID' order by ID DESC");
 ...
 <td><center><a href="JavaScript:if(confirm('Are You Sure To Delete This Note ?')==true)
{window.location='Delete_Note.php?N_ID=<?php echo $N_ID; ?>&B_ID=<?php echo $B_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a></center></td>
 </tr>
