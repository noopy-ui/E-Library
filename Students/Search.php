...
?>  			
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from books where Type='Softcopy' AND Category_ID='$Category_ID' order by ID DESC");
 ...
 <div class="ibox-title">
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from books where Category_ID='$Category_ID' AND Type='Hardcopy' order by ID DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
