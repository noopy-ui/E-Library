...
$Header = "From: E-Library - Contact Us Form | ".$Full_Name." - ".$Email_Address;
...
<li class="">
					<a href="Student_Signin.php" title="Students Signin"><i class="fa fa-users"></i> <span class="nav-label">Students Sigin</span></a>
                    </li>
